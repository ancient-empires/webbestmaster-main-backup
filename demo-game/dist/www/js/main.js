...
gi2315['/www/js/services/info.js'] = info;
...
var info = gi2315['/www/js/services/info.js'] || window.info;
...
gi2315['/www/js/services/log.js'] = log;
...
var log = gi2315['/www/js/services/log.js'] || window.log;
...
gi2315['/www/js/services/mediator.js'] = mediator;
...
var $ = gi2315['/www/js/lib/jbone.js'] || window.$;
...
gi2315['/www/js/lib/queue.js'] = Queue;
}());
(function () {
'use strict';
/*global window */

var Backbone = gi2315['/www/js/lib/backbone.js'] || window.Backbone;
var mediator = gi2315['/www/js/services/mediator.js'] || window.mediator;
var log = gi2315['/www/js/services/log.js'] || window.log;
...
gi2315['/www/js/services/device.js'] = device;
}());
(function () {
'use strict';
/*global window, Date */
...
gi2315['/www/js/services/android-ads.js'] = androidAds;
...
var info = gi2315['/www/js/services/info.js'] || window.info;
var en = gi2315['/www/js/i18n/en.js'] || window.en;
var ru = gi2315['/www/js/i18n/ru.js'] || window.ru;
...
gi2315['/www/js/services/lang.js'] = lang;
...
var doT = gi2315['/www/js/lib/dot.js'] || window.doT;
...
gi2315['/www/js/services/template-master.js'] = templateMaster;
...
//var $ = gi2315['/www/js/lib/jbone.js'] || window.$;
//var Queue = gi2315['/www/js/lib/queue.js'] || window.Queue;
// tangram
...
gi2315['/www/js/services/util.js'] = util;
}());
(function () {
'use strict';
/*global window */
...
gi2315['/www/js/sound/player-android.js'] = androidPlayer;
}());
(function () {
'use strict';
/*global window */
...
gi2315['/www/js/sound/player-ios.js'] = iosPlayer;
...
gi2315['/www/js/sound/player-web.js'] = webPlayer;
...
var androidPlayer = gi2315['/www/js/sound/player-android.js'] || window.androidPlayer;
var iosPlayer = gi2315['/www/js/sound/player-ios.js'] || window.iosPlayer;
var webPlayer = gi2315['/www/js/sound/player-web.js'] || window.webPlayer;
var info = gi2315['/www/js/services/info.js'] || window.info;
...
gi2315['/www/js/sound/sound-master.js'] = soundMaster;
...
var Backbone = gi2315['/www/js/lib/backbone.js'] || window.Backbone;
var $ = gi2315['/www/js/lib/jbone.js'] || window.$;
var _ = gi2315['/www/js/lib/lodash.js'] || window._;
var info = gi2315['/www/js/services/info.js'] || window.info;
//var tm = gi2315['/www/js/services/template-master.js'] || window.tm;
var util = gi2315['/www/js/services/util.js'] || window.util;
var mediator = gi2315['/www/js/services/mediator.js'] || window.mediator;
var sm = gi2315['/www/js/sound/sound-master.js'] || window.sm;
var lang = gi2315['/www/js/services/lang.js'] || window.lang;
var device = gi2315['/www/js/services/device.js'] || window.device;
var log = gi2315['/www/js/services/log.js'] || window.log;
...
gi2315['/www/js/app/view/core/base.js'] = BaseView;
}());
(function () {
'use strict';
/*global window */

var BaseView = gi2315['/www/js/app/view/core/base.js'] || window.BaseView;
var tm = gi2315['/www/js/services/template-master.js'] || window.tm;
var info = gi2315['/www/js/services/info.js'] || window.info;
var log = gi2315['/www/js/services/log.js'] || window.log;
...
gi2315['/www/js/app/view/home/column-view.js'] = ColumnView;
}());
(function () {
'use strict';
/*global window */
...
var Backbone = gi2315['/www/js/lib/backbone.js'] || window.Backbone;
var ColumnView = gi2315['/www/js/app/view/home/column-view.js'] || window.ColumnView;
...
gi2315['/www/js/app/view/home/column-model.js'] = ColumnModel;
}());
(function () {
'use strict';
/*global window */
...
var BaseView = gi2315['/www/js/app/view/core/base.js'] || window.BaseView;
var Backbone = gi2315['/www/js/lib/backbone.js'] || window.Backbone;
var ColumnModel = gi2315['/www/js/app/view/home/column-model.js'] || window.ColumnModel;
...
gi2315['/www/js/app/view/home/col-collection.js'] = GameCollection;
}());
(function () {
'use strict';
/*global window */
...
var BaseView = gi2315['/www/js/app/view/core/base.js'] || window.BaseView;
var tm = gi2315['/www/js/services/template-master.js'] || window.tm;
var ColCollection = gi2315['/www/js/app/view/home/col-collection.js'] || window.ColCollection;
...
gi2315['/www/js/app/view/home/game-view.js'] = HomeView;
}());
(function () {
'use strict';
/*global window */
...
var _ = gi2315['/www/js/lib/lodash.js'] || window._;
var BaseView = gi2315['/www/js/app/view/core/base.js'] || window.BaseView;
var HomeView = gi2315['/www/js/app/view/home/game-view.js'] || window.HomeView;
...
gi2315['/www/js/app/router/router.js'] = router;
}());
(function () {
'use strict';
/*global window */
...
gi2315['/www/js/app/view/core/hint.js'] = hintMaster;
}());
(function () {
'use strict';
/*global window */
...
gi2315['/www/js/app/view/core/popup.js'] = popupMaster;
}());
(function () {
'use strict';
/*global window */
...
gi2315['/www/js/services/app-cache.js'] = appCache;
...
// init all librares
var polyfillClassList = gi2315['/www/js/lib/polyfill-class-list.js'] || window.polyfillClassList;
var shim = gi2315['/www/js/lib/shim.js'] || window.shim;
var shimES5 = gi2315['/www/js/lib/shim-es5.js'] || window.shimES5;
var shamES5 = gi2315['/www/js/lib/sham-es5.js'] || window.shamES5;
var _ = gi2315['/www/js/lib/lodash.js'] || window._;
var $ = gi2315['/www/js/lib/jbone.js'] || window.$;
var Deferred = gi2315['/www/js/lib/deferred.js'] || window.Deferred;
var Backbone = gi2315['/www/js/lib/backbone.js'] || window.Backbone;
var fastclick = gi2315['/www/js/lib/fastclick.js'] || window.fastclick;
var doT = gi2315['/www/js/lib/dot.js'] || window.doT;
var Queue = gi2315['/www/js/lib/queue.js'] || window.Queue;

// init all services
var device = gi2315['/www/js/services/device.js'] || window.device;
var androidAds = gi2315['/www/js/services/android-ads.js'] || window.androidAds;
var lang = gi2315['/www/js/services/lang.js'] || window.lang;
var tm = gi2315['/www/js/services/template-master.js'] || window.tm;
var util = gi2315['/www/js/services/util.js'] || window.util;
...
var router = gi2315['/www/js/app/router/router.js'] || window.router;

var BaseView = gi2315['/www/js/app/view/core/base.js'] || window.BaseView;
var hintMaster = gi2315['/www/js/app/view/core/hint.js'] || window.hintMaster;
var popupMaster = gi2315['/www/js/app/view/core/popup.js'] || window.popupMaster;

var appCache = gi2315['/www/js/services/app-cache.js'] || window.appCache;
