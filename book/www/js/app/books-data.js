	...
	win.APP.booksData = {
		ru: [
			...
			},
			{
				...
				pages: [
					{
						text: 'Повстречались как-то раз Лиса и Журавль:<br />- Как дела, Лиса-кума?<br />- Да всё бы хорошо, куманёк, да вот летать я не умею...<br />- Так давай я тебя научу! Садись верхом!<br />Уселась лиса на Журавля, поднялись они высоко в небо. Земля внизу - меньше горошины!<br />- Ну что, кума, готова?<br />- Да уж готова, а как летать-то?<br />- А вот прямо так и лети! - сказал Журавль и сбросил Лису со спины. Та камнем полетела вниз, хорошо ещё, что в стог сена угодила.',
						time: 44.0845
					},
					{
