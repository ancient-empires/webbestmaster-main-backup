		...
		ru: [
			...
			},
			{
				...
				pages: [
					...
					{
						text: '- Работу ищу!|- Нанимайся ко мне!|- А какая работа?|- Воду кипятить.|- А уговор какой?|- Сто рублей в год!|- Ладно, согласен! Вот голос говорит:|- Забор!|Забор в ответ человечьим голосом:|- Что, хозяин?|- Отворись!',
						time: 27.39225
					},
					{
