(function (win) {
	...
	win.langs.ru = {
		...
		missions: {
			c01_regroup: {
				A1Header: 'Часть 1',
				A1: 'Королевство Торин разделено. Преданный собственным братом-близнецом Валадорном, Король Галамар спасься бегством в граничных землях на востоке. Только Голубая охрана, личные войска Галамара, остались ему верными и готовы вернуть страну...',
