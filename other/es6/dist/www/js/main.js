...
var booksData = {
	ru: [{
		...
		pages: [{
			...
			text: 'Встретил в лесу барана:|- Давай, друг, зимовье строить! Я стану из леса брёвна носить, да столбы тесать, а ты будешь щепу драть.|- Ладно, согласен, - отвечает баран.|Повстречали бык и баран свинью:|- Пойдём, Хавроньюшка, с нами, зимовье стр��ить! Мы станем брёвна носить, столбы тесать, щепу драть, а ты будешь глину месить, кирпичи делать, печку класть!|Согласилась и свинья. Увидели бык, баран и свинья кота:|- Здравствуй, Котофеевич, пойдём вместе зимовье строить!',
			time: 54.429
		}, {
...
var _viewBook = require('./../view/book');

var _viewBook2 = _interopRequireDefault(_viewBook);
...
var win = window,
	...
	openBook: function openBook(bookFolder) {

		new _viewBook2['default']({
...
},{"./../../lib/backbone":12,"./../../lib/lodash":17,"./../../services/mediator":27,"./../view/book":5,"./../view/core/base":6,"./../view/home":9}],5:[function(require,module,exports){
'use strict';
/*global window */
...
var _booksData = require('./../books-data');

var _booksData2 = _interopRequireDefault(_booksData);
...
var win = window,
    BookView = _coreBase2['default'].extend({
	...
	initialize: function initialize(dataArg) {

		var view = this,
		    data = dataArg || {},
		    languageName = _servicesInfo2['default'].get('language'),
		    booksByLang = _booksData2['default'][languageName],
		    book = _libLodash2['default'].find(booksByLang, { folder: data.bookFolder });

		view.set('withText', false);

		view.set('pageMode', 'normal'); // fullText or normal

		view.setElement(_servicesTemplateMaster2['default'].tmplFn.book({
			info: _servicesInfo2['default'],
			util: _servicesUtil2['default'],
			book: book,
			settings: {
		...
		view.set('url', _libBackbone2['default'].history.fragment);

		view.set('playerState', 'playing'); // playing or pause

		view.set('previousPageIndex', 0);

		_coreBase2['default'].prototype.initialize.apply(view, arguments);
		//view.onResize();

		view.loadBooksImages().then(function () {
			...
			if (_servicesInfo2['default'].hintIsDone('showTitle')) {
	...
	checkNeedUrl: function checkNeedUrl() {
		return this.get('url') === _libBackbone2['default'].history.fragment;
	},
	...
	initSwiper: function initSwiper() {
		...
		swiper = new _libSwiper2['default']('.swiper-container', {
			// Optional parameters
	...
	bindEventListeners: function bindEventListeners() {
		...
		swiper.on('onDoubleTap', function () {
			return view.toggleState();
		});

		view.listenTo(_servicesDevice2['default'], 'resize', view.onResize);
	},
	...
	onResize: function onResize() {
		...
		var view = this,
		    ...
		    topBarHeight = _servicesInfo2['default'].get('remSize', true) * 3.4; // see style css .header

		$pages.each(function () {

			var $page = (0, _libJbone2['default'])(this),
				...
				height: _servicesDevice2['default'].get('height') - textHeight - topBarHeight
			},
			    image = {
	...
	loadBooksImages: function loadBooksImages() {

		var view = this,
		    book = view.get('book'),
		    mainBookFolder = 'books',
		    pages = book.pages,
		    language = _servicesInfo2['default'].get('language'),
		    bookFolder = book.folder,
		    loadDeferred = _libJbone2['default'].Deferred(),
		    loadPromise = loadDeferred.promise(),
		    getPath = _servicesUtil2['default'].getPath,
		    mainDeferred = _libJbone2['default'].Deferred();
		...
		_libLodash2['default'].each(pages, function (page, index) {
	...
	runPage: function runPage(dataArg) {
	...
	autoSetPlayPauseButtonState: function autoSetPlayPauseButtonState() {
	...
	showTextAnimation: function showTextAnimation(dataArg) {
	...
	doNextActionAfter: function doNextActionAfter(timeout) {
		...
		currentTimeoutId = win.setTimeout(function () {
			...
			isStoryByStory = _servicesInfo2['default'].get('storyByStory') === 'on';

			if (isStoryByStory) {
				view.hide().then(function () {

					// detect book/:bookFolder
					if (_libBackbone2['default'].history.fragment.indexOf('book/') !== 0) {
						return;
					}

					var languageName = _servicesInfo2['default'].get('language'),
					    books = _booksData2['default'][languageName],
				...
				view.routeBack();
				setTimeout(_servicesAndroidAds2['default'].showAd, 3e3);
			}
		}, timeout * 1e3); // 1e3
	...
	stopCurrentPage: function stopCurrentPage() {
	...
	playCurrentPage: function playCurrentPage() {
	...
	isPageChanged: function isPageChanged(pageIndex) {
	...
	showInnerHtml: function showInnerHtml(e) {

		var view = this,
		    html = (0, _libJbone2['default'])(e.currentTarget).html();
	...
	hide: function hide() {
		...
		return _coreBase2['default'].prototype.hide.call(view);
	}
...
},{"./../../lib/backbone":12,"./../../lib/jbone":16,"./../../lib/lodash":17,"./../../lib/swiper":19,"./../../services/android-ads":21,"./../../services/device":23,"./../../services/info":24,"./../../services/template-master":28,"./../../services/util":29,"./../../sound/sound-master":33,"./../books-data":3,"./core/base":6}],6:[function(require,module,exports){
'use strict';
/*global window */
...
},{"./../../../lib/backbone":12,"./../../../lib/jbone":16,"./../../../lib/lodash":17,"./../../../services/info":24,"./../../../services/lang":25,"./../../../services/mediator":27,"./../../../services/util":29,"./../../../sound/sound-master":33}],7:[function(require,module,exports){
'use strict';
/*global window */
...
},{"./../../../lib/jbone":16,"./../../../lib/lodash":17,"./../../../services/device":23,"./../../../services/info":24,"./../../../services/lang":25,"./../../../services/mediator":27,"./../../../services/template-master":28,"./base":6}],8:[function(require,module,exports){
'use strict';
/*global window */
...
},{"./../../../lib/jbone":16,"./../../../lib/lodash":17,"./../../../services/info":24,"./../../../services/mediator":27,"./../../../services/template-master":28,"./../../../sound/sound-master":33,"./base":6}],9:[function(require,module,exports){
'use strict';
/*global window */
...
var _servicesBg = require('./../../services/bg');

var _servicesBg2 = _interopRequireDefault(_servicesBg);
...
var win = window,
	...
	initialize: function initialize() {
		...
		// show hint if needed
		if (!_servicesInfo2['default'].hintIsDone('autoplay')) {
			view.publish('showHint', { name: 'autoplay' }, hintViewAutoplay);
			hintViewAutoplay.view.onHide(function () {
				return view.publish('showHint', { name: _servicesInfo2['default'].isNormal ? 'removeAds' : 'thanksForBuy' });
			});
		}

		_servicesBg2['default'].changeBg();

		return _coreBase2['default'].prototype.initialize.apply(view, arguments);
	},

	getBooksOnShelfNumber: function getBooksOnShelfNumber() {

		var view = this,
		    remSize = _servicesInfo2['default'].get('remSize', true),
		    bookWidth = 8.8,
		    // SEE CSS
		availableWidth = _servicesDevice2['default'].get('width') / remSize,
	...
	setStoryByStory: function setStoryByStory(e) {

		var view = this,
		    $this = (0, _libJbone2['default'])(e.currentTarget),
		    notification = _servicesLang2['default'].get('notification'),
		    popupText,
		    isStoryByStory = _servicesInfo2['default'].get('storyByStory') === 'on';

		if (isStoryByStory) {
			$this.removeClass('active-on-off');
			_servicesInfo2['default'].set('storyByStory', 'off');
			popupText = notification.storyByStoryOff;
		} else {
			$this.addClass('active-on-off');
			_servicesInfo2['default'].set('storyByStory', 'on');
	...
	bindEventListeners: function bindEventListeners() {
		...
		view.listenTo(_servicesDevice2['default'], 'change:orientation', function () {
			view.publish('hide-hint', {}, { doNotTrack: true });
			view.loadUrl();
		});
		...
		rateUsTimeoutId = setTimeout(function () {
			...
			if (Date.now() - _servicesInfo2['default'].get('installTime') > 20e3) {
				view.rateUsPopup();
			}
		}, 2e3);
	...
	openBook: function openBook(e) {
		...
		var view = this,
		    $node = (0, _libJbone2['default'])(e.currentTarget),
		...
		$node.attr('data-is-clicked', '1').addClass('book-titles-wrapper-clicked');
	}
...
},{"./../../lib/jbone":16,"./../../services/bg":22,"./../../services/device":23,"./../../services/info":24,"./../../services/lang":25,"./../../services/template-master":28,"./../books-data":3,"./core/base":6}],10:[function(require,module,exports){
'use strict';
/*global window */
...
},{"./app/router/router":4,"./app/view/core/base":6,"./app/view/core/hint":7,"./app/view/core/popup":8,"./lib/backbone":12,"./lib/deferred":13,"./lib/fastclick":15,"./lib/jbone":16,"./lib/lodash":17,"./lib/shim":18,"./lib/swiper":19,"./services/android-ads":21,"./services/bg":22,"./services/device":23,"./services/info":24,"./services/lang":25,"./services/log":26,"./services/mediator":27,"./services/template-master":28,"./services/util":29,"./sound/sound-master":33}],21:[function(require,module,exports){
'use strict';
/*global window */
...
},{"./info":24}],22:[function(require,module,exports){
'use strict';
/*global window */
/*global $, Image*/
...
var bg = {
	...
	init: function init() {
		...
		var bgMaster = this,
		    $wrapper = (0, _libJbone2['default'])('.js-wrapper');
	...
	loadAllBgs: function loadAllBgs() {

		var bgMaster = this,
		    i,
		    imgDeferred = _libJbone2['default'].Deferred(),
...
},{"./../lib/jbone":16}],23:[function(require,module,exports){
'use strict';
/*global window */
...
},{"./../lib/backbone":12}],24:[function(require,module,exports){
'use strict';
/*global window */
...
},{"./../i18n/en":10,"./../i18n/ru":11,"./info":24}],26:[function(require,module,exports){
'use strict';
/*global console */
...
},{"./../lib/dot":14}],29:[function(require,module,exports){
'use strict';
/*global window */
...
},{"./../services/info":24,"./player-android":30,"./player-ios":31,"./player-web":32}]},{},[20]);
