	...
	win.sections.proVremya = {
		...
		questions: [
			...
			},
			{
				...
				answer: 'Запустим часы одновременно. Через 7 мин. начнем отсчет времени. Как только упадет последняя песчинка в 11-минутных часах, перевернем их и отмерим еще 11 мин._!_Альтернативное решение:<br>1. Запускаем двое песочных часов что бы отмерить 7 минут<br>2. Переворачиваем 7-ми минутные часы и ждём пока не закончатся 11-ти минутные часы<br>3. Снова переворачиваем 7-ми минутные часы, и ждём когда они закончатся - тогда и будет 15 минут.'
			},
			{
			...
			},
			{
				...
				answer: 'Она должна их перевернуть одновременно; когда в часах №1 песок пересыпется, она должна поставить пирог в печь; в часах №2 песок продолжает пересыпаться на протяжении еще 4-х минут; спустя 4 минуты Натали снова переворачивает часы №2 и ждет, пока весь песок не пересыпется. Итого получаем 4 + 11 = 15 минут._!_Альтернативное решение:<br>1. Запускаем двое песочных часов что бы отмерить 7 минут<br>2. Переворачиваем 7-ми минутные часы и ждём пока не закончатся 11-ти минутные часы<br>3. Снова переворачиваем 7-ми минутные часы, и ждём когда они закончатся - тогда и будет 15 минут.'
			},
			{
