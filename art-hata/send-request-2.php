...
$mail->AddAddress('dmitriy.turovtsov@viaden.com', 'arthata.by'); // êîìó - àäðåñ, Èìÿ
...
$roistatContent = 'name - '.$name.'; email - '.$email.'; content - '.$content.'; extra - '.$extra.'; works-type - '.$works_type.';';
